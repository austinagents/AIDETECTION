    ...
    messages: [
      {
        role: "system",
        content:
          "You provide explainable writing revision suggestions. Do not promise to bypass detectors or make writing undetectable. Preserve meaning. Return strict JSON only."
      },
      {
        role: "user",
